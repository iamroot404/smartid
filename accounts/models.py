...
class MyAccountManager(BaseUserManager):
    def create_user(self, first_name, last_name, username,registration_number,phone_number, email, password=None):
        if not email:
    ...
    def create_superuser(self, first_name, last_name, email, username,registration_number,phone_number, password):
